...
urlpatterns = [
    ...
    path('empresas/<int:empresa_id>/add_documento/', views.add_documento, name='add_documento'),
    path('documento/<int:documento_id>/delete/<int:empresa_id>/', views.delete_documento, name='delete_documento'),
    ...
    path('chamado/<int:chamado_id>/adicionar_prestadora_servico/', views.gerenciar_chamado_view, name='adicionar_prestadora_servico'),
    ...
    path('view_signature_tecnico/<int:chamado_id>/', views.view_signature_tecnico, name='view_signature_tecnico'),
    path('save_signature_tecnico/<int:chamado_id>/', views.save_signature_tecnico, name='save_signature_tecnico'),
    ...
    path('chamado/<int:chamado_id>/documentacao/download-emer-corre/', views.down_doc_fotos_emrg_corre, name='down_doc_fotos_emrg_corre'),
